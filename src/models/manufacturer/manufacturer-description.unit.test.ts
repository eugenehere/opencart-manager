...
import { initialManufacturerDescription } from "../../initial";
import { toFieldset } from "../../utils";
import ManufacturerDescriptionModel from "./manufacturer-description";

const fakeDatabase = new FakeDatabase();
const model = new ManufacturerDescriptionModel(fakeDatabase);

const table: string = "manufacturer_description";
const data = { manufacturerId: 123, languageId: 1, name: "testNameLang1" };
const updated = { ...data, name: "testNameLang1 updated" };
const criteria = { manufacturerId: data.manufacturerId, languageId: 1 };
const initialValues = initialManufacturerDescription;
